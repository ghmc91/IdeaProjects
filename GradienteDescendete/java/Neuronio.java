package java;
/**
 * Criado por Gustavo Costa
 */

import org.nd4j.linalg.api.ndarray.INDArray;
import org.nd4j.linalg.factory.Nd4j;

import static org.nd4j.linalg.ops.tranforms.Transforms.*;

public class Neuronio {
    // pesos e número de entradas do neurônio
    INDArray w;
    int n;
...

    {
        ...
        //Inicializa os pesos passando o número de entradas mais 1 (bias)
    ...
    public void treinaNeuronio(INDArray x, INDArray y, double taxaDeAprendizagem, int epoch) {
        // Armazeno o número de exemplos enviados para o treinamento
        int n_examples = x.size(0);
        //Cria a coluna do bias com todos os valores sendo 1
        INDArray x_bias = Nd4j.ones(n_examples, 1);
        INDArray X = Nd4j.hstack(x_bias, x);

        //Para cada epoch
        for (int i = 0; i < epoch; i++) {
            //Encontra o valor de h fazendo uma multiplicação de matrizes
