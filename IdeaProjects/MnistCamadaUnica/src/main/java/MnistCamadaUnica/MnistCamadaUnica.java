 ...
 * a soma das saías de cada um dos dez neurônios da camada de saída seja um. O neurônio que possuir
...
public class MnistCamadaUnica {
    public static void main(String[] args) throws Exception {
        ...
        int outputNum = 10; // nÃºmero de classes de saÃ­da
        int batchSize = 128; // tamanho do batch para cada iteraÃ§Ã£o
        int seed = 123; // seed para manter a reprodutibilidade
        int numEpochs = 15; // nÃºmero de epochs
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
                ...
                // gradiente descendente estocÃ¡stico
        ...
        while(mnistTest.hasNext()){
            ...
            INDArray output = model.output(next.getFeatureMatrix()); //pegando a prediÃ§Ã£o da rede
            eval.eval(next.getLabels(), output); //comparando a prediÃ§Ã£o com os valores esperados
        }
