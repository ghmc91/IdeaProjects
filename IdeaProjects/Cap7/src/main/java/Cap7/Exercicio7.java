...
public class Exercicio7 {
    ...
    public static void main(String[] args) {
        ...
        int i = 0;
        Span[] tokensPositions = tokenizer.tokenizePos(sentence);
        for (Span tokenPosition : tokensPositions) {
            System.out.println("Token " + i + ": " + tokens[i] +
                    " começa em " + tokenPosition.getStart() +
                    " e termina em " + (tokenPosition.getEnd() -1));
            i++;
        }
